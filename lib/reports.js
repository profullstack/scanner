...
function generateJsonReport(scanResult, options = {}) {
  ...
  // For backward compatibility with tests and existing integrations
  const backwardCompatibleReport = {
    metadata: {
    ...
    // Include enhanced data for new integrations
    enhanced: enhancedReport
  };
  
  return JSON.stringify(backwardCompatibleReport, null, 2);
}
